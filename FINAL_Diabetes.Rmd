...
admission_type_id_map <- c('1'='Emergency',
                           '2'='Emergency',
                           '3'='Elective',
                           '4'='Elective',
                           '5'=NA,
...
age_count <- table(diab_dt$age_mean)

age_count <- age_count[order(age_count)]

barplot(age_count, xlab="age", ylab="Count", 
     main = "Distribution of Ages (Mean)", width=0.5, space=0.5, col="lightblue")
