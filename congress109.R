...
# They both choose 5.  If you start from 1, BIC would have chosen that!

# you should go with whatever makes sense to you: 
# I go with 5.
kmfs <- kfit[[1]] 
...
# note that you might get different results (since clustering changes with random restarts)
