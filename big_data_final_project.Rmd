...
A1C_inference1_dt <- diab_dt[, -c("payer_code", "medical_specialty", "weight", "diag_1", "diag_2", "diag_3", "A1Cresult", "readmitted")] 
```
...
```{r}
fit.1 <- glm(readmitted_binary ~ . - patient_nbr - encounter_id, 
